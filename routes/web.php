...
Route::get('/taskList', [App\Http\Controllers\TaskController::class, 'index'])->name('task.list');
Route::post('/saveTask', [App\Http\Controllers\TaskController::class, 'store'])->name('task.save');
Route::get('/getTaskById/{id}', [App\Http\Controllers\TaskController::class, 'edit'])->name('task.edit');
Route::post('/updateTask/{id}', [App\Http\Controllers\TaskController::class, 'update'])->name('task.update');
Route::get('/deleteTask/{id}', [App\Http\Controllers\TaskController::class, 'delete'])->name('task.remove');
Route::get('/assign-task/{id}', [App\Http\Controllers\TaskController::class, 'assignTask'])->name('task.assign');
Route::post('/assign-task-to-user/{id}', [App\Http\Controllers\TaskController::class, 'assignTaskToUser'])->name('task.assign.user');
